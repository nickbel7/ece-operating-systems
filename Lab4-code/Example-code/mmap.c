...
int main(void)
{
         ...
         */
        heap_private_buf = mmap(heap_private_buf, buffer_size, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS, -1,0);
        show_maps();
        /*
         ...
         */
        char *heap_zeros_buf;
        heap_zeros_buf = mmap(heap_zeros_buf, buffer_size,PROT_READ | PROT_WRITE, MAP_ANONYMOUS,-1,0);
        //get_physical_address(heap_private_buf);
        int i;
        /*heap_zeros_buf[0] = 0;
        ...
        */
         ...
         */
        FILE *fdd;
        fdd = fopen("file.txt","r+");
        file_shared_buf = mmap(file_shared_buf, buffer_size, PROT_READ| PROT_WRITE, MAP_SHARED,fdd,0);
        get_physical_address(file_shared_buf);
        /*
